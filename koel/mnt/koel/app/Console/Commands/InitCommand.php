...
class InitCommand extends Command
{
    ...
    {
        $this->components->task('Sync songs', function (): void {
            Artisan::call('koel:scan', ['-n' => true]);
        });
    }
    ...
    private function setUpDatabase(): void
    {
        ...
        $config['DB_DATABASE'] = $_SERVER['DB_DATABASE'] ?: "/var/www/html/database/data.db";
