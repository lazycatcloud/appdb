...
/**
 * Strings for component 'tool_moodlenet', language 'zh_cn', version '4.3'.
 *
...
$string['autoenablenotification'] = '<p>在Moodle 4.0以上版本中，<a href="https://moodle.net/">MoodleNet</a> 集成在高级功能中是默认启用的。具有创建和管理活动能力的用户可以通过活动选择器浏览MoodleNet，并将MoodleNet资源导入其课程中。</p><p>如果需要，可以在<a href="{$a->settingslink}">MoodleNet settings</a>中指定一个备用的MoodleNet实例</p>';
